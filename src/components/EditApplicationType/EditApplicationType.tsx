...
import {
  CustomFormProps,
  EditApplicationTypeFormFieldType,
} from './EditApplicationType.types';

const EditApplicationType = React.forwardRef<
...
>(({ SubmitButton, dispatch, mode, application, ...extraProps }, ref) => {
  ...
  const onFinish: FormProps<EditApplicationTypeFormFieldType>['onFinish'] = ({
    name,
    description,
  }) => {
